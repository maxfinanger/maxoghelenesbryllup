    ...
    <div className="container mx-auto px-6 py-16">
      ...
      <div className="w-full mx-auto space-y-8 text-base md:text-lg text-muted-foreground leading-relaxed">
        <p className="text-center">
          Den beste gaven dere kan gi oss er deres tilstedeværelse på vår store
          dag!
        </p>

        <div className="bg-secondary/40 rounded-lg p-8 md:p-10 text-center">
          <p className="mb-4">
            Hvis dere likevel ønsker å gi oss noe, setter vi stor pris på bidrag
            til vår bryllupsreise.
          </p>
